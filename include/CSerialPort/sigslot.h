...
template <class mt_policy> class has_slots;
...
template <class mt_policy> class _signal_base : public mt_policy
{
public:
...
template <class mt_policy = SIGSLOT_DEFAULT_MT_POLICY> class has_slots : public mt_policy
{
private:
...
template <class mt_policy> class _signal_base0 : public _signal_base<mt_policy>
{
public:
...
template <class dest_type, class mt_policy> class _connection0 : public _connection_base0<mt_policy>
{
public:
    _connection0()
    {
...
template <class mt_policy = SIGSLOT_DEFAULT_MT_POLICY> class signal0 : public _signal_base0<mt_policy>
{
public:
